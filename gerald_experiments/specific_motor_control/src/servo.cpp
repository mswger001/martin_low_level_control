...
int main(int argc, char **argv)
{
    ...
    ros::param::get("/robot_joint", robot_joint);
    ros::param::get("/joint_angle_position", position);
    ...
    //i can move one joint at a time with a specified wanted postion  joint number and then duration

    // Perform joint motion initialization with the specified values
    joint_motion_init(position, robot_joint, duration);
